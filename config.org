...
;; Keybinding for hover info (Shift-K in evil normal mode)
(map! :after eglot
      :map eglot-mode-map
      :n "K" #'eldoc-doc-buffer  ; Show hover info in dedicated buffer
      :n "g K" #'eglot-code-actions) ; Code actions with g K
#+end_src
